 ...
 * `--------------------------------------------|               /    \              |----------------------------------------------'
 *                         | LALT | LGUI  | DEL |LOWER | Space /      \Enter| RAISE |BackSP| RGUI | RALT |
 *                         `----------------------------------'        '---------------------------------'
 */
[_QWERTY]= LAYOUT(
    ...
    KC_LSFT, KC_Z,  KC_X,    KC_C,    KC_V,    KC_B,    KC_LPRN, KC_LBRC,  KC_RBRC, KC_RPRN, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                             KC_LALT, KC_LGUI, KC_DEL,  TL_LOWR, KC_SPC,   KC_ENT,  TL_UPPR, KC_BSPC, KC_RGUI, KC_RALT
),
/* LOWER
* QWERTY
 * ,--------------------------------------------.                                   ,----------------------------------------------.
